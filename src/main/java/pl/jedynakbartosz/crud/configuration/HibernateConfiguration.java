package pl.jedynakbartosz.crud.configuration;
...
@ComponentScan({"pl.jedynakbartosz.crud.configuration"})
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactoryBean.setPackagesToScan(new String[]{"pl.jedynakbartosz.crud.model"});
